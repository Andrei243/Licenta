...
class Scene1 :public SceneManager {
	...
	void Init() {
		...
		resourceManager->addModel(1, ceutils::generateModelFromObj("Resources/Models/Astronaut.obj"));
		...
		resourceManager->addTexture(1, ceutils::generateFromPhoto("LINEAR", "LINEAR", "CLAMP_TO_EDGE", "CLAMP_TO_EDGE", "Resources/Textures/profil.jpg"));
