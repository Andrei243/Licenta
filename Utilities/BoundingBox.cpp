...
bool BoundingBox::verifyCollision(BoundingBox o1, BoundingBox o2) {
	bool x, y, z;
	x = y = z = false;
...
BoundingBox BoundingBox::calculateBoundingBox(Vector3 rotatie, Vector3 scale, Vector3 pos) {
...
BoundingBox::BoundingBox(std::vector<Vertex>vertexi) {
